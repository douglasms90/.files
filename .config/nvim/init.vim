...
" Para buscar mais informações com que cada comando faz, só dentro do Vim só :h e o comando para ter uma descrição precisa com cada comando faz dentro do vim.
...
set relativenumber  	" Show number in format relative
...
set hidden		    	" Hides the current buffer when a new files is openned
...
set encoding=utf-8	    " The encoding should be utf-8 to active the font icons
set nobackup		    " No backup files
set nowritebackup	    " No backup files
set splitright		    " Create the vertical splits to the right
set splitbelow		    " Create the horizontal split below
